...
#python3 expert_pickandplace.py --algo tqc --env FetchPickAndPlace-v1 --no-render --folder rl-trained-agents/ -n 10000
#python3 expert_pickandplace.py --algo tqc --env FetchPickAndPlace-v1 --folder rl-trained-agents/ -n 1000 
